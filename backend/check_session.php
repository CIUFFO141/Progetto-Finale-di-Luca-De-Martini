...
if( $_SESSION['log'] && !isset( $_COOKIE['session_id'] )){
    ...
    // include("key.php");
    $session_id = openssl_encrypt( $unique_id , "AES-128-CTR", $_ENV['SECRET_KEY'], 0 , $encryption_iv);
    ...
    $encryption_iv = '1234567891011121';
    include("key.php");
    $unique_id = openssl_decrypt( $session_id , "AES-128-CTR", $_ENV['SECRET_KEY'], 0 , $encryption_iv);
